...
def generar_nomina_grupal(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            frecuencia_ince = getattr(INCE, 'frecuencia_aplicacion', '').strip().lower()
            ...
            for empleado in empleados:
                ...
                ince_bs = (base_seg_social * INCE.porcentaje) if es_dia_pago_ince else Decimal('0')
