...
urlpatterns = [
    ...
    path('crear-usuario/', views.crear_usuario_normal, name='crear_usuario_normal'),
    path('error-grupo/', views.error_grupo, name='error_grupo'),
   ...
   # path('asistencias/toggle/<int:pk>/', views.toggle_asistencia, name='toggle_asistencia'),
    ...
    path('nomina/departamento/', views.generar_nomina_por_departamento, name='generar_nomina_departamento'),
