...
urlpatterns = [
   ...
   # path('asistencias/toggle/<int:pk>/', views.toggle_asistencia, name='toggle_asistencia'),
    ...
    path('prestamos/', views.listar_prestamos, name='listar_prestamos'), # Para la redirección
    ...
    path('nomina/nueva/', views.generar_nomina_nueva, name='generar_nomina_nueva'),
    path('nomina/nueva/pdf/<int:nomina_id>/', views.nomina_pdf_nueva, name='nomina_pdf_nueva'),
]
