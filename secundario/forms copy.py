...
from .models import Empleado, Departamento, Profesion, Labor, TipoDeJornada, Nomina, Sueldo, Tasa, Asistencia, Usuarios, Liquidacion,Prestamo, ParametrosNomina, SueldoLabor
